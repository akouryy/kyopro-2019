...
if(h&w&1){assert(i0%2==j0%2);if(i0%2==0){bool swp=i0==0||j0==w-1;
if(swp){swap(h,w);swap(i0,j0);swap(i,j);
}
...
if(h&w&1){assert(i0%2==j0%2);if(i0%2==0){if(i0==0||j0==w-1){swap(h,w);
swap(i0,j0);swap(i,j);
}
